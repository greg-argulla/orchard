...
const MainDisplay = (props: MainDisplayProps) => {
  ...
  return (
    <section className="relative mb-32 mt-32 flex min-h-[540px] min-w-[320px] flex-wrap px-5 sm:flex-nowrap sm:gap-5 lg:px-5">
      ...
      <div className="sw-full top-1/2 min-w-[320px] py-5 sm:absolute sm:mr-5 sm:-translate-y-1/2 sm:bg-black sm:bg-opacity-60 sm:px-5 lg:relative lg:top-0 lg:w-2/6 lg:translate-y-0 lg:bg-transparent lg:p-0 ">
